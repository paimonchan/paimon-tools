 ...
 */
export default function Sidebar({ activeId, onSelect, onOpenPalette, open, onClose }) {
  return (
    <>
      {open && (
        <div
                  ...
                  return (
                    <li key={tool.id}>
                      <button
                        ...
                        className={[
                          'group relative flex w-full items-center gap-2.5 rounded-md px-3 py-1.5 text-[13px]',
