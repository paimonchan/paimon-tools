...
**30 tools** across five categories, plus a multi-language code playground.
...
| [Video FPS Reducer](https://paimonchan.github.io/paimon-tools/video-fps/) | Lower a video's frame rate (60 → 30, 24, 15 fps) without changing its length or speed |
